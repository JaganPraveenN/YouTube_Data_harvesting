...
def Api_connect():
    Api_ID="AIzaSyAx4dB-WDILB_nrv4OogW4ZB6pVVZebu5o"
    ...
    for video_id in video_ids:
        ...
        for item in response['items']:
            data=dict(Channel_Name=item['snippet']['channelTitle'],
                    Channe_Id=item['snippet']['channelId'],
                    Video_Id=item['id'],
...
with st.sidebar:
    st.title(':red[YOUTUEB DATA HARVESTING AND WAREHOUSING]')
...
question=st.selectbox('Select you question',('1. All the videos and the channel name',
                                             '2. Channels with most number of vidoes',
...
if question=="1. All the videos and the channel name":
...
elif question=="2. Channels with most number of vidoes":
    ...
    query4='''select comments as no_comments,video_title as videotitle from videos where comments is not null'''
    ...
    query5='''select video_title as videotitle,channel_name as channelname,likes as likecount
    ...
    query6='''select likes as likecount,video_title as vidoetitle from videos '''
    cursor.execute(query6)
    mydb.commit()
    t6=cursor.fetchall()
    df6=pd.DataFrame(t6,columns=['Like Count','Vidoe Title'])
    st.write(df6)
    ...
    query8='''select video_title as videotitle,published_date as videorelease,channel_name as channelname from videos
